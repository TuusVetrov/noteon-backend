...
class NoteDaoImpl @Inject constructor() : NoteDaoFacade {
    override suspend fun add(userId: String, title: String, body: String): String = DatabaseFactory.dbQuery {
        NoteEntity.new {
    ...
    override suspend fun update(id: String, title: String, body: String): String  = DatabaseFactory.dbQuery {
